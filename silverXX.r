...
#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1100,662000,0))
#save(out,file="silverXX_findbug.RData")

#this is the runner file part
out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,mig,662000,0))

save(out,file=paste("silverXX_",mig,"_",seed,".RData",sep=""))        
