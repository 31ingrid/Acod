...
//high fishsel this is 60% CI
fishselB[0]=0.2190;fishselB[1]=0.8604;fishselB[2]=0.9664;fishselB[3]=0.8924;fishselB[4]=0.7866;fishselB[5]=0.8086;fishselB[6]=0.8086;
...
mu=0.12*as<double>(rbeta(1,0.6,1));//here scale down by 1/100 so max is 0.01 OR not
...
save(out,file=paste("platinumFF_losel_",ssba,"_",mig,"_",seed,".RData",sep="")) 
