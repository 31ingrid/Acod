...
mu=0.15*as<double>(rbeta(1,0.6,1));//here scale down by 1/100 so max is 0.01 OR not
...
tallyhowmanyA=Counter;
}//end of rich


Rcout<<"tallyhowmanyA"<<std::endl;
Rf_PrintValue(wrap(tallyhowmanyA));
...
//if ((k>1)&(k%5==0)){//only mutate every generation, estimating by 5 yrs
double prob;
double dir;
...
//}//end of if every 5 yrs
//MIGRATION


if ((k>1)&(k%1==0)){
Rcout<<"second migration"<<std::endl;
//nmig=as<int>(rlnorm(1,3.5075,1));//for mean 55
//nmig=as<int>(rlnorm(1,3.6,1));//trying higher for mean 55
//nmig=as<int>(rlnorm(1,6.74425,1));//for mean 1400
//nmig=as<int>(rlnorm(1,7.48105,1));//for mean 2925
//nmig=as<int>(rlnorm(1,6.94425,1));//trying higher for mean 1400
nmig=as<int>(rlnorm(1,7.7105,1));//trying higher for mean 2925
...
save(out,file=paste("platinumFF_lnorm_tryhigher3_",ssba,"_",mig,"_",seed,".RData",sep="")) 
