...
//Q_a[0]= 0.03226423;Q_a[1]= 0.14982172;Q_a[2]= 0.48225745;Q_a[3]= 0.83117813;Q_a[4]= 0.96299517;Q_a[5]= 0.99278248;Q_a[6]= 0.99862647;

//95% quantile maturity for comparison
Q_a[0]=0.046;Q_a[1]=0.164;Q_a[2]=0.514;Q_a[3]=0.895;Q_a[4]=1;Q_a[5]=1;Q_a[6]=1;
...
#this is the runner file part
out=run2pops(c(ssba,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,mig,331000,0))

save(out,file=paste("silverJJ_",ssba,"_",mig,"_",seed,".RData",sep=""))  
