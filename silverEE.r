...
FishB=as<double>(rlnorm(1,-2.19,0.38));//this is FullF for B40%
...
#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1000,65000,0))
#save(out,file="silverEE6_1.RData")

#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1000,65000,0))
#save(out,file="silverEE6_2.RData")

#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1000,65000,0))
#save(out,file="silverEE6_3.RData")

#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1000,65000,0))
#save(out,file="silverEE6_4.RData")

#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1000,65000,0))
#save(out,file="silverEE6_5.RData")

out=run2pops(c(ssba,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,mig,65000,0))

save(out,file=paste("silverEE_",ssba,"_",mig,"_",seed,".RData",sep=""))  


#out=run2pops(c(34000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1000,350000,0))
##out=run2pops(c(3400,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1000,3500,0))
#save(out,file="silverA3_1.RData") 
