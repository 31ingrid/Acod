...
#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1200,100000,0))
#save(out,file="silverBB8_1.RData")

#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1200,100000,0))
#save(out,file="silverBB8_2.RData")

#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1200,100000,0))
#save(out,file="silverBB8_3.RData")

#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1200,100000,0))
#save(out,file="silverBB8_4.RData")

#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1200,100000,0))
#save(out,file="silverBB8_5.RData")

#out=run2pops(c(15000,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,1200,100000,0))
#save(out,file="silverBB8_6.RData")


out=run2pops(c(ssba,0.5,700,100,1,.34,0.12,1,1,3000,1000,1,1.15,1,7,1,13,mig,100000,0))

save(out,file=paste("silverBBB_",ssba,"_",mig,"_",seed,".RData",sep="")) 
